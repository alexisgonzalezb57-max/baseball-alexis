...
<head>
    ...
    <title>Homenajes - Sistema Baseball</title>
    ...
    <main class="main-content">
        <div class="container">
            <div class="content-container">
                <h1 class="page-title">Listado de Homenajes</h1>
                
                <div class="text-center">
                    <a href="form.php">
                        <button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Agregar nuevo homenaje">
                            <i class="fas fa-plus-circle me-2"></i>Agregar Homenaje
                        </button>
                    </a>
                </div>
                ...
                <div class="table-container">
                    <div class="table-header">
                        <h5 class="mb-0"><i class="fas fa-trophy me-2"></i>Homenajes Registrados</h5>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($data['honor']); ?></td>
                                    <td>
                                        <div class="action-buttons">
                                            <a href="formedit.php?id=<?php echo $data['id_hnr']; ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
                                                <button type="button" class="buto btn btn-warning">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            </a>
                                            <a href="delet.php?id=<?php echo $data['id_hnr']; ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar" onclick="return confirm('¿Estás seguro de eliminar este homenaje?')">
                                ...
                                <?php 
                                    ...
                                    echo '<tr><td colspan="5" class="empty-state"><i class="fas fa-inbox"></i><br>No hay homenajes registrados</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
