...
if (!isset($_POST['categoria']) || !isset($_POST['temporada']) || !isset($_POST['honor'])) {
...
$guardar = "INSERT INTO homenaje SET 
    id_temp = '$temporada',
    categoria = '$categoria',
    honor = '$honor',
    cant_four = '$cant_four',
...
if ($resaves) {
    session_start();
    $_SESSION['mensaje'] = "Homenaje guardado correctamente";
    $_SESSION['tipo_mensaje'] = "success";
} else {
    session_start();
    $_SESSION['mensaje'] = "Error al guardar el homenaje: " . mysqli_error($con);
