...
<head>
    ...
    <title>Equipos - <?php echo htmlspecialchars($cat); ?></title>
    ...
    <main class="main-content">
        <div class="container">
            <div class="teams-container">
                <h1 class="page-title">Lista de Equipos - Categoría "<?php echo htmlspecialchars($cat); ?>"</h1>
                
                <div class="action-buttons mb-4">
                    <a href="form.php?cat=<?php echo urlencode($cat); ?>" class="btn btn-primary">
                        <i class="fas fa-plus-circle me-2"></i>Nuevo Equipo
                    </a>
                    <a href="../equipos/" class="btn btn-info">
                ...
                <div class="table-container">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                $obtener = "SELECT * FROM equipos WHERE categoria LIKE '%$cat%'";
                                $query = mysqli_query($con, $obtener);
                                
                                if (!$query) {
                                    echo "<tr><td colspan='4' class='text-center text-danger'>Error en la consulta: " . mysqli_error($con) . "</td></tr>";
                                } else {
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td class="fw-bold"><?php echo htmlspecialchars($data['nom_team']); ?></td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="formedit.php?id=<?php echo $data['id_team']; ?>&cat=<?php echo urlencode($cat); ?>" class="btn btn-warning btn-action" data-bs-toggle="tooltip" title="Editar">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="deletteam.php?id=<?php echo $data['id_team']; ?>&cat=<?php echo urlencode($cat); ?>" class="btn btn-danger btn-action" data-bs-toggle="tooltip" title="Eliminar" onclick="return confirm('¿Estás seguro de que deseas eliminar este equipo?');">
                                ...
                                <?php
                                        ...
                                        echo "<tr><td colspan='4' class='text-center'>
                                            <div class='empty-state'>
                                                ...
                                                <h4>No hay equipos en esta categoría</h4>
