...
<head>
    ...
    <title>Nueva Temporada - Baseball</title>
    ...
    <main class="main-content">
        <div class="container">
            <div class="form-container">
                <h1 class="form-title">Nueva Temporada</h1>
                <p class="text-muted text-center mb-4">Completar los datos</p>
                
                <form method="POST" action="create.php">
                    <div class="mb-3 row">
                        <label class="col-sm-4 col-form-label">Nombre de Temporada</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control-plaintext" id="input" name="n_temp" placeholder="Temp. 2025" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            <input type="number" min="0" class="form-control-plaintext" id="input" name="n_games" value="10" required>
                        </div>
                    </div>
                    
                    <div class="mb-3 row">
                        <label class="col-sm-4 col-form-label">Número de Innings</label>
                        <div class="col-sm-2">
                            <input type="number" min="0" class="form-control-plaintext" id="input" name="n_innings" value="7" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            <input type="number" min="0" step=".01" class="form-control-plaintext" id="input" name="juego" value="2.50" required>
                        </div>
                    </div>
