...
<head>
    ...
    <title>Reportes de Resumen - Sistema Baseball</title>
...
<body>
        ...
        <div class="container">
            <div class="content-container">
                <div class="header-actions">
                    <h1 class="page-title">📊 Reportes de Resumen</h1>
                    <a href="reporte.php" class="btn btn-info">
                        <i class="fas fa-arrow-left me-2"></i>Volver a Reportes
                    </a>
                </div>
                
                <p class="text-center text-muted mb-4">Seleccione los parámetros para generar el reporte de resumen de jugadores y pitchers</p>

                <form method="POST" target="_blank" action="../PDF/resumen.php" id="resumenForm">
                    <!-- Sección de Filtros -->
                    ...
                    <div class="btn-container">
                        <button type="submit" class="btn btn-success" id="submitBtn">
                            <i class="fas fa-file-pdf me-2"></i>Generar Resumen PDF
                        </button>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        document.getElementById('resumenForm').addEventListener('submit', function(e) {
