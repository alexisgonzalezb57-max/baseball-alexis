...
<head>
    ...
    <title>Reportes de Asistencias - Sistema Baseball</title>
...
<body>
        ...
        <div class="container">
            <div class="content-container">
                <div class="header-actions">
                    <h1 class="page-title">📋 Reportes de Asistencias</h1>
                    <a href="reporte.php" class="btn btn-info">
                        <i class="fas fa-arrow-left me-2"></i>Volver a Reportes
                    </a>
                </div>
                
                <p class="text-center text-muted mb-4">Seleccione los parámetros para generar el reporte de asistencias en formato PDF</p>

                <form method="POST" target="_blank" action="../PDF/asistencia.php" id="asistenciaForm">
                    ...
                    <!-- Sección de Valor de Asistencia -->
                    <div class="form-section">
                        <h5 class="section-title"><i class="fas fa-money-bill-wave"></i> Valor de Asistencia</h5>
                        ...
                        <div class="row">
                            <div class="col-md-8 mx-auto">
                                ...
                                <div class="value-info">
                                    ...
                                    <p class="mb-0">Ingrese el valor que representa cada asistencia. Este valor se utilizará para calcular los totales en el reporte.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.getElementById('asistenciaForm').addEventListener('submit', function(e) {
            ...
            const valor = document.querySelector('input[name="valorval"]');
            ...
            if (!valor.value || parseFloat(valor.value) <= 0) {
                e.preventDefault();
                showAlert('Por favor, ingrese un valor válido para la asistencia', 'warning');
                valor.focus();
                return;
            }
