...
<body>
  <section>
    ...
    <!--  System Card -->
          <div class="list">
            <div class="seudo"></div>
                <h4 class="titulo">Reportes - Asistencias</h4>
                <form method="POST" target="_blank" action="../PDF/asistencia.php">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-3 col-form-label">Valor de la Asistencia</label>
                            <div class="col-sm-3">
                              <input type="number" class="form-control-plaintext alte" required id="input" name="valorval">
                            </div>
                        </div>
