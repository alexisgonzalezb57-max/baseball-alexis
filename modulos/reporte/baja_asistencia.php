...
<head>
    ...
    <title>Jugadores con Baja Asistencia - Sistema Baseball</title>
...
<body>
        ...
        <div class="container">
            <div class="content-container">
                <div class="header-actions">
                    <h1 class="page-title">⚠️ Jugadores con Baja Asistencia</h1>
                    <a href="reporte.php" class="btn btn-info">
                        <i class="fas fa-arrow-left me-2"></i>Volver a Reportes
                    </a>
                </div>
                
                <p class="text-center text-muted mb-4">Seleccione los parámetros para generar el reporte de jugadores con 3 o menos asistencias</p>

                <form method="POST" target="_blank" action="../PDF/baja_asistencia_pdf.php" id="bajaAsistenciaForm">
                    <!-- Sección de Filtros Básicos -->
                    <div class="form-section">
                        <h5 class="section-title">
                            <i class="fas fa-filter"></i> Filtros de Búsqueda
                            <span class="stats-badge">
                                <i class="fas fa-exclamation-triangle"></i> 3 o menos asistencias
                            </span>
                        </h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select" id="equipone" name="equipo" disabled>
    ...
    <script>
        ...
        $(document).ready(function(){
            $("#categoria").change(function(){
                ...
                if (categoria) {
                    ...
                    equipoSelect.prop('disabled', true).html('<option value="0">Todos los equipos</option>');
            ...
            $("#tempo").change(function(){
                ...
                if (tempo) {
                    ...
                    $.get("tempo.php", "tempo=" + tempo, function(data){
                        $("#equipoLoading").hide();
                        // Añadir opción "Todos los equipos" al inicio
                        equipoSelect.html('<option value="0">Todos los equipos</option>' + data).prop('disabled', false);
                    }).fail(function() {
                        $("#equipoLoading").hide();
                        equipoSelect.html('<option value="0">Todos los equipos</option>');
                    });
                } else {
                    equipoSelect.prop('disabled', true).html('<option value="0">Todos los equipos</option>');
                }
        ...
        document.getElementById('bajaAsistenciaForm').addEventListener('submit', function(e) {
