...
<head>
    ...
    <title>Reportes de Historial - Sistema Baseball</title>
        ...
        <div class="container">
            <div class="content-container">
                <div class="header-actions">
                    <h1 class="page-title">📊 Reporte de Historial</h1>
                    <a href="reporte.php" class="btn btn-info">
                        <i class="fas fa-arrow-left me-2"></i>Volver a Reportes
                    </a>
                </div>
                
                <p class="text-center text-muted mb-4">Seleccione los parámetros para generar el reporte de historial del equipo</p>

                <form method="POST" target="_blank" action="../PDF/historial.php" id="historialForm">
