...
<body>
  <section>
    ...
    <!--  System Card -->
          <div class="list">
            <div class="seudo"></div>
                <h4 class="titulo">Reportes - Pichers: Ganados | Efectividad</h4>
                <form method="POST" target="_blank" action="../PDF/pichers.php">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Maximo total de JJ para IL (Efectividad): </label>
                            <div class="col-sm-4">
                              <input type="number" class="form-control-plaintext alte" required id="input" name="actual">
                            </div>
                        </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#tempo").change(function(){
      $.get("ilefec.php","tempo="+$("#tempo").val(), function(data){
        $("#valor").html(data);
        console.log(data);
      });
    });
