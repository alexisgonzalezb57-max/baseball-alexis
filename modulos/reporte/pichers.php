...
<head>
    ...
    <title>Reportes de Pichers - Sistema Baseball</title>
...
<body>
        ...
        <div class="container">
            <div class="content-container">
                <div class="header-actions">
                    <h1 class="page-title">⚾ Reportes de Pichers</h1>
                    <a href="reporte.php" class="btn btn-info">
                        <i class="fas fa-arrow-left me-2"></i>Volver a Reportes
                    </a>
                </div>
                
                <p class="text-center text-muted mb-4">Seleccione los parámetros para generar el reporte de pichers (ganados y efectividad)</p>

                <form method="POST" target="_blank" action="../PDF/pichers.php" id="pichersForm">
                    ...
                    <!-- Sección de Configuración de Efectividad -->
                    <div class="form-section">
                        <h5 class="section-title"><i class="fas fa-sliders-h"></i> Configuración de Efectividad</h5>
                        
                        <div class="row">
                            <div class="col-md-8 mx-auto">
                                <label class="form-label required-field">Máximo total de JJ para IL (Efectividad)</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-chart-line"></i></span>
                                    <input type="number" class="form-control" name="actual" required min="0" step="1" placeholder="Ingrese el valor máximo">
                                </div>
    ...
    <script>
        ...
        document.getElementById('pichersForm').addEventListener('submit', function(e) {
            ...
            if (!actual.value || parseInt(actual.value) <= 0) {
                e.preventDefault();
                showAlert('Por favor, ingrese un valor válido para el máximo de JJ', 'warning');
                actual.focus();
                return;
            }
