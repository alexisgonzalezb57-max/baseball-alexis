        ...
        <div class="container">
            <div class="content-container">
                <div class="header-actions">
                    <h1 class="page-title">⚡ Reportes de Líderes en Dobles y Triples</h1>
                    <a href="reporte.php" class="btn btn-info">
                        <i class="fas fa-arrow-left me-2"></i>Volver a Reportes
                    </a>
                </div>
                
                <p class="text-center text-muted mb-4">Seleccione los parámetros para generar el reporte de líderes en dobles y triples</p>

                <form method="POST" target="_blank" action="../PDF/lid2b3b.php" id="lideresForm">
                    <!-- Sección de Filtros Básicos -->
                    <div class="form-section">
                        <h5 class="section-title">
                            <i class="fas fa-filter"></i> Filtros de Búsqueda
                            <span class="stats-badge">
                                <i class="fas fa-running"></i> Dobles | Triples
                            </span>
                        </h5>
