...
<head>
    ...
    <title>Reportes de Nómina - Sistema Baseball</title>
        ...
        <div class="container">
            <div class="content-container">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="page-title">👥 Reportes de Nómina</h1>
                    <a href="reporte.php" class="btn btn-info">
                        <i class="fas fa-arrow-left me-2"></i>Volver a Reportes
                    </a>
                </div>
                
                <p class="text-center text-muted mb-4">Seleccione los parámetros para generar el reporte de nómina en formato PDF</p>

                <form method="POST" target="_blank" action="../PDF/nomina.php">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select" id="equipone" name="equipo" required>
                    ...
                    <div class="form-section">
                        <h5 class="section-title"><i class="fas fa-cog"></i> Opciones de Reporte</h5>
                        
                        <div class="option-group">
                            <div class="option-header">
                                <i class="fas fa-exchange-alt"></i> Cuadro de Sustitución
                            </div>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-list"></i></span>
                                <select class="form-select" name="sust" required>
                                    <option value="1">Sí - Incluir cuadro de sustitución</option>
                                    <option value="0">No - Omitir cuadro de sustitución</option>
                                </select>
                            </div>
                            <div class="form-text">Incluir u omitir el cuadro de sustitución en el reporte generado</div>
                        </div>
                    </div>

                    <div class="btn-container">
                        <button type="submit" class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Generar reporte de nómina en PDF">
    ...
    <script>
        ...
        $(document).ready(function(){
            $("#categoria").change(function(){
                ...
                if (categoria) {
                    $.get("list.php", "categoria=" + categoria, function(data){
                        $("#equipone").html(data);
                    });
                } else {
                    $("#equipone").html('<option value="">Primero seleccione una categoría</option>');
                }
            });
        });
