...
<body>
  <section>
    ...
    <!--  System Card -->
          <div class="list">
            <div class="seudo"></div>
                <h4 class="titulo">Reportes - Nomina</h4>
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Cuadro Sustitucion</label>
                            <div class="col-sm-4">
                              <select class="form-control-plaintext alte" required id="input" name="sust">
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#categoria").change(function(){
      $.get("list.php","categoria="+$("#categoria").val(), function(data){
        $("#equipone").html(data);
        console.log(data);
      });
    });
