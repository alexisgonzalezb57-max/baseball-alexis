...
<body>
  <section>
    ...
    <!--  System Card -->
          <div class="list">
            <div class="seudo"></div>
                <h4 class="titulo">Reportes - Abonos</h4>
                <form method="POST" target="_blank" action="../PDF/abono.php">
                ...
                <div class="card-body">
                  ...
                  <div class="card-footer">
                      <button style="color: #000;" type="submit" class="btn btn-success" value="search" data-toggle="tooltip" data-placement="top" title="Generar Resumen">Generar</button>
