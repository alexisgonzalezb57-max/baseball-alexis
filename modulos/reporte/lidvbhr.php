...
<body>
  <section>
    ...
    <!--  System Card -->
          <div class="list">
            <div class="seudo"></div>
                <h4 class="titulo">Reportes - Lideres - En Bateo | En Jonrones</h4>
                <form method="POST" target="_blank" action="../PDF/lidvbhr.php">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">VB: </label>
                            <div class="col-sm-4">
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#tempo").change(function(){
      $.get("valor.php","tempo="+$("#tempo").val(), function(data){
        $("#valor").html(data);
        console.log(data);
      });
    });
