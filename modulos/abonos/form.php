...
<head>
    ...
    <title>Definir Abonos - Sistema Baseball</title>
    ...
    <main class="main-content">
        <div class="container">
            <div class="content-container">
                <h1 class="page-title">💰 Definir Abonos</h1>
                <p class="text-center text-muted mb-4">Establece la temporada, la cantidad de abonos y los premios</p>
                ...
                <form method="POST" action="create.php">
                    ...
                    <div class="btn-container">
                        <button type="submit" class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Guardar configuración">
