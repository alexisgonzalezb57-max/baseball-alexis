...
<body>
	<section>
		...
		<!--  System Card -->
		  <div class="list">
            <div class="seudo"></div>
		    	<h4 class="titulo">Listado de Temporadas para ABONAR</h4><br>
                <a href="form.php">
                <button type="button" class="btn btn-primary">Definir Abono de la Temporada</button>
                </a>
                <br><br>
				<div class="cardList">
					<table class="table table-hover table-sm table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="alte"><?php echo $data['ncantidad'] ?></td>
                                <td class="alte">
                                <?php if ( empty($data['prize_four']) ){echo 'NO';} else {echo 'SI';} ?>
                                </td>
                                <td>
                                    <a href="list.php?idn=<?php echo $data['id_abn'] ?>&id=<?php echo $data['id_temp'] ?>&cat=<?php echo $data['categoria'] ?>"><button type="button" class="buto btn btn-info" data-toggle="tooltip" data-placement="top" title="Ingresar Abonos"><ion-icon name="cash-outline"></ion-icon></button></a>

                                    <a href="formedit.php?id=<?php echo $data['id_abn'] ?>"><button type="button" class="buto btn btn-warning" data-toggle="tooltip" data-placement="top" title="Editar"><ion-icon name="create-outline"></ion-icon></button></a>
                                    <a href="delet.php?id=<?php echo $data['id_abn'] ?>"><button type="button" class="buto btn btn-danger" data-toggle="tooltip" data-placement="top" title="Eliminar"><ion-icon name="trash-outline"></ion-icon></button></a>
                                </td>
                            </tr>
                            <?php } } ?>
                        </tbody>
