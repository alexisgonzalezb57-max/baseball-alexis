...
$stadis = "SELECT * FROM jugadores WHERE id_team = $id_team AND id_player NOT IN (SELECT id_player FROM resumen_stats WHERE tnj = $nj AND id_temp = $id_temp);";
...
$stadis = "SELECT * FROM jugadores WHERE id_team = $id_team AND id_player IN (SELECT id_player FROM resumen_stats WHERE tnj = $nj AND id_temp = $id_temp);";
$stsquy = mysqli_query($con, $stadis);
$nomnsts = mysqli_num_rows($stsquy);
      if ($nomnsts >= 1) {
        for ($sts=1; $sts <= $nomnsts ; $sts++) { 
          ...
          $guardarstats = "UPDATE resumen_stats SET cedula       = '$cedula',
                                                    name_jgstats = '$name_stats' 
