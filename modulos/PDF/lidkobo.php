...
// config document
$pdf->SetTitle(utf8_decode('Líderes en Ponches | Boletos - Categoria '.$categoria));
...
$pdf->Ln(2);
$pdf->Cell(0,5,utf8_decode('LÍDERES EN PONCHES'),0,1,'C');
...
$pdf->Cell(15,6.5,utf8_decode(strtoupper('k')),1,0,'C');
...
$covl = "SELECT * FROM resumen_stats WHERE id_temp = $temporada ORDER BY k DESC";
...
$pdf->Cell(15,6.5,utf8_decode($player['k']),1,0,'C');
...
$pdf->Ln(8);
$pdf->SetFont('Arial','',14);
$pdf->Cell(0,5,utf8_decode('LÍDERES EN BOLETOS'),0,1,'C');
$pdf->Ln(2);
...
$pdf->Cell(10,6.5,utf8_decode(strtoupper('pos')),1,0,'C');
$pdf->Cell(85,6.5,utf8_decode(strtoupper('Nombre')),1,0,'C');
$pdf->Cell(15,6.5,utf8_decode(strtoupper('b')),1,0,'C');
$pdf->Cell(70,6.5,utf8_decode(strtoupper('Equipo')),1,1,'C');
...
$covl = "SELECT * FROM resumen_stats WHERE id_temp = $temporada ORDER BY b DESC";
$vais = mysqli_query($con, $covl);
$asnm = mysqli_num_rows($vais);
...
$pdf->Cell(10,6.5,utf8_decode(strtoupper($jg)),1,0,'C');
$pdf->Cell(85,6.5,utf8_decode($player['name_jgstats']),1,0,'C');
$pdf->Cell(15,6.5,utf8_decode($player['b']),1,0,'C');
...
$covl = "SELECT * FROM resumen_stats WHERE id_team = $equipo ORDER BY k DESC";
$vais = mysqli_query($con, $covl);
$asnm = mysqli_num_rows($vais);
...
$covl = "SELECT * FROM resumen_stats WHERE id_team = $equipo ORDER BY b DESC";
$vais = mysqli_query($con, $covl);
$asnm = mysqli_num_rows($vais);
