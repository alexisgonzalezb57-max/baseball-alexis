...
$revisar = "SELECT equipos.*, jugadores.* FROM equipos INNER JOIN jugadores ON 
equipos.id_team = jugadores.id_team WHERE jugadores.id_player = $id";
...
<head>
    ...
    <title>Editar Jugador - <?php echo htmlspecialchars($data['nom_team'] ?? ''); ?></title>
    ...
    <main class="main-content">
        <div class="container">
            <div class="form-container">
                <h1 class="page-title">Editar Jugador</h1>
                ...
                <form method="POST" action="update.php">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cedula" name="cedula" value="<?php echo htmlspecialchars($data['cedula'] ?? ''); ?>" onkeyup="formatNumber(this)" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="fecha_nacimiento" class="form-label">Fecha de Nacimiento</label>
                                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha" value="<?php echo htmlspecialchars($data['fecha'] ?? ''); ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo htmlspecialchars($data['nombre'] ?? ''); ?>" placeholder="Nombre" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="apellido" class="form-label">Apellido del Jugador</label>
                                <input type="text" class="form-control" id="apellido" name="apellido" value="<?php echo htmlspecialchars($data['apellido'] ?? ''); ?>" placeholder="Apellido" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="edad" name="edad" value="<?php echo htmlspecialchars($data['edad'] ?? ''); ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="d-flex">
                                    <div class="form-check me-4">
                                        <input class="form-check-input" type="radio" name="lanz" id="lanz_si" value="1" <?php echo ($data['lanzador'] == 1) ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="lanz_si">Sí</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="lanz" id="lanz_no" value="0" <?php echo ($data['lanzador'] == 0 || empty($data['lanzador'])) ? 'checked' : ''; ?>>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <a href="list.php?id=<?php echo $team; ?>&cat=<?php echo urlencode($cat); ?>" class="btn btn-info me-3">
